...
import { PolicyCard } from "../components/index";
...
const Home = () => {
    ...
    |  Fetch policies
    |-------------------------------------------------------------------------- */
    const fetchPoliciesAll = async () => {
        try {
            setIsLoading(true);
            const response = await policyService.getPoliciesAll();
            setPolicies(response.policies.reverse());
        } catch (error) {
            console.error('Error fetching policies:', error);
            openNotificationWithIcon('error', 'Erreur', 'Erreur lors du chargement des politiques');
        } finally {
            setIsLoading(false);
        }
    };
                ...
                <div className="container">
                    <div className="hero-inner">
                        <div className="hero-copy">
                            <h1 className="hero-title mt-0 animate__animated animate__bounceInLeft">Remboursement sans
                                tracas, gestion simplifiée</h1>
                            <p className="hero-paragraph mb-4 animate__animated animate__bounceInLeft">
                                Soumettez, suivez, et recevez vos remboursements rapidement et en toute sécurité..</p>

                            <div className="hero-buttons d-flex gap-2">
                                <Link to='/login' className="link animate__animated animate__bounceInLeft">Se
                                    connecter</Link>
                                <Link to='/register' className="link animate__animated animate__bounceInLeft">Créer
                                    un compte</Link>
                            </div>
                        </div>
                        <div className="hero-illustration">
                            <div className="hero-shape hero-shape-1">
                                <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <circle className="animate__animated animate__bounceInUp" cx="20" cy="20" r="20"
                                            fill="#FFD8CD" fillRule="evenodd"/>
                                </svg>
                            </div>
                            <div className="hero-shape hero-shape-2">
                                <svg width="88" height="88" xmlns="http://www.w3.org/2000/svg"
                                     style={{overflow: "visible"}}>
                                    <circle className="animate__animated animate__bounceInUp" cx="44" cy="44" r="44"
                                            fill="#FFD2DA" fillRule="evenodd"/>
                                </svg>
                            </div>
                            <div className="hero-main-shape">
                                <svg width="940" height="647" viewBox="0 0 940 647" xmlns="http://www.w3.org/2000/svg"

                                     xmlnsXlink="http://www.w3.org/1999/xlink" style={{overflow: "visible"}}>
                                    <defs>
                                    ...
                                    <g fill="none" fillRule="evenodd">
                                        <path className="animate__animated animate__bounceInUp"
                                        ...
                                        <g transform="translate(435 518)">
                                            <circle className="animate__animated animate__bounceInUp"
                                                    fill="url(#hero-illustration-b)" cx="106" cy="32" r="32"/>
                                            <circle className="animate__animated animate__bounceInUp"
                                                    fill="url(#hero-illustration-c)" cx="12" cy="117" r="12"/>
                                        </g>
                                        <g className="animate__animated animate__fadeInRight">
                                            <g transform="translate(103 75)">
                                                <path fillOpacity=".24" fill="#11103E"
                                            ...
                                            <g transform="translate(396 157)">
                                                ...
                                                <path stroke="url(#hero-illustration-h)" strokeWidth="3"
                                        ...
                                        <g className="animate__animated animate__fadeInRight">
                                            <g transform="translate(56 157)">
                                                ...
                                                <path
                                                    ...
                                                    fill="url(#hero-illustration-n)" fillRule="nonzero"/>
                                            </g>
                                        </g>
                                        <g>
                                            <g className="animate__animated animate__fadeInRight">
                                            ...
                                            <g className="animate__animated animate__fadeInRight">
                                                ...
                                                <text fontFamily="AppleColorEmoji, Apple Color Emoji" fontSize="19"
                                            ...
                                            <g className="animate__animated animate__fadeInRight">
                                                ...
                                                <text fontFamily="AppleColorEmoji, Apple Color Emoji" fontSize="16"
                    ...
                    <div className="features-inner section-inner">
                        <div className="features-header text-center">
                            <div className="container-sm">
                                <h2 className="section-title mt-0">Les politiques de remboursements</h2>
                                <p className="section-paragraph">Merci de verifier les politiques ci dessous avant de passer votre demande de remboursement.</p>
                            </div>
                        </div>
                            ...
                            <div className="content">
                                {
                                    policies && policies.length > 0 ? (
                                        ...
                                        <div className="col-12 text-center">
                                            <h1 className="fs-6 p-2">Contacter l administration pour savoir les politiques de remboursement</h1>
                                            <Button className='link p-4 mt-2 login-btn'>contacter</Button>
                                        </div>
                                    )
                                }
                            </div>
